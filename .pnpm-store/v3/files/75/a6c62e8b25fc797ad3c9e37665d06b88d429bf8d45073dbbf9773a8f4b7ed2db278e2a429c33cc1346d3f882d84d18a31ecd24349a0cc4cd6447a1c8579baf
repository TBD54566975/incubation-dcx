...
import { CompactSdJwtVc, IPresentation, IProof, IProofPurpose, IProofType, OriginalVerifiableCredential, SdJwtDecodedVerifiableCredential, W3CVerifiablePresentation } from '@sphereon/ssi-types';
...
export type SdJwtDecodedVerifiableCredentialWithKbJwtInput = SdJwtDecodedVerifiableCredential & {
