...
import { DwnInterface, getPaginationCursor, getRecordAuthor, isDwnMessage } from '@web5/agent';
...
export class Record {
    ...
    delete(deleteParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const _a = deleteParams || {}, { store, signAsOwner, dateModified } = _a, params = __rest(_a, ["store", "signAsOwner", "dateModified"]);
            ...
            if (this.deleted) {
                ...
                deleteOptions.messageParams = Object.assign(Object.assign({}, params), { recordId: this._recordId, messageTimestamp: dateModified });
            }
    ...
    readRecordData({ target, isRemote }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { reply: { status, record } } = yield agentResponsePromise;
                if (status.code !== 200) {
