...
function getDwnEndpoints(did) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let endpoints = (_b = (_a = didDocument === null || didDocument === void 0 ? void 0 : didDocument.service) === null || _a === void 0 ? void 0 : _a.find(service => service.type === 'DecentralizedWebNode')) === null || _b === void 0 ? void 0 : _b.serviceEndpoint;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // If the code gets here, it is not a SW env, it is likely DOM, but check to be sure
                ...
                if (!registration) {
                    // @ts-ignore
                    const installUrl = options.path || (globalThis.document ? (_b = document === null || document === void 0 ? void 0 : document.currentScript) === null || _b === void 0 ? void 0 : _b.src : (_c = importMetaIfSupported()) === null || _c === void 0 ? void 0 : _c.url);
                    if (installUrl)
                        navigator.serviceWorker.register(installUrl, { type: 'module' }).catch(error => {
