...
export type WalletConnectOptions = {
     ...
     */
    requestedProtocolsAndScopes: Map<string, {
        /**
...
export declare class Web5 {
     ...
     */
    static connect({ agent, agentVault, connectedDid, password, recoveryPhrase, sync, techPreview, didCreateOptions, registration }?: Web5ConnectOptions): Promise<Web5ConnectResult>;
}
