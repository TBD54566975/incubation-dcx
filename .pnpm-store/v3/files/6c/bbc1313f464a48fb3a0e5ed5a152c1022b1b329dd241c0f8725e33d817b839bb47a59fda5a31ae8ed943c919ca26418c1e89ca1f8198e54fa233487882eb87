...
describe('RecordsWrite schema definition', () => {
    ...
    it('should throw if `contextId` is malformed', () => {
        ...
        const invalidMessage1 = Object.assign({}, validMessage);
