...
export class StorageController {
    ...
    performRecordsDelete({ tenant, message }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield StorageController.deleteAllOlderMessagesButKeepInitialWrite(tenant, existingMessages, message, this.messageStore, this.dataStore, this.eventLog);
        });
    }
    /**
