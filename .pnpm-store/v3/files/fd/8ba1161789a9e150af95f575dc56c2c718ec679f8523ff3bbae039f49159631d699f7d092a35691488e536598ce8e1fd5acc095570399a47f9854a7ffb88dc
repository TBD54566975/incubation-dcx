...
export class MessagesReadHandler {
    ...
    handle({ tenant, message }) {
        return __awaiter(this, void 0, void 0, function* () {
            let messagesRead;
            try {
                messagesRead = yield MessagesRead.parse(message);
            }
            catch (e) {
            ...
            const messageResult = yield this.messageStore.get(tenant, message.descriptor.messageCid);
            ...
            const entry = { message: messageResult, messageCid: message.descriptor.messageCid };
